...
class ShoppingCartContents extends Component {
    ...
    return (
      <div className='cart__contents'>
        {this.props.contents.map((item, index) => {
          return(
            <div className='cart__item' key={_.uniqueId()}>
              <div className="item__visual">{item.image}</div>
              <div className='cart__main-product' key={_.uniqueId()}>
              ...
              <div className='cart__options'>
                {item.options.map((item, i) => {
                  return (
                    <div className='cart__option' key={_.uniqueId()}>
  ...
  render() {
    console.log('Props inside ShoppingCartContents:', this.props);
    return (
      <div>
